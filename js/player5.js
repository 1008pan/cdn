...
if (navigator.userAgent.match(/(iPhone|iPod|iPad|Android|ios|Nokia|Black Berry|MIDP|Phone)/i) && mobiles === "no") {
	...
	if (myhkLoad && window.location.href.indexOf("music.zhaiwu.me") < 0) {
		$("#myhkplayer").hide()
	} else {
		var songSheetList;
		var webURL = 'https://music.zhaiwu.me/';
		var keyId = $("#xplayer").attr("key");
		console.log("Nani音乐播放器插件：" + webURL);
		localStorage.setItem("myhkLoad", "true");
        $("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\""+webURL+"Static/player5/css/player.css\">");
...
"<div id=\"myhkLrc\"></div>");
		if (top.location != self.location) {
			...
			$songFrom.html("<a style=\"color:#f00\">Nani</a>");
				...
				creat: {
					album: function() {
						if (typeof myhkid === "undefined") {
							...
							$(".musicheader", $albumList).html("<a href=\"" + webURL + "\" title=\"欢迎使用Nani播放器</a>")
						};
			...
			$.ajax({
				...
				success: function() {
					if (typeof myhkid !== "undefined") {
						$(".myhkgeci", $player).html("<a style=\"float: right\" href=\"" + webURL + "\" title=\"Nani播放器\" target=\"_blank\"><i class=\"fa fa-share-alt\"></i> 免费申请</a>");
